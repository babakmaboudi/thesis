\chapter{Conservative Model Order Reductin of Fluid Flow} \label{chapter:7}
...
To accelerate assembly of the nonlinear terms we may approximately evaluate them using the DEIM, see \Cref{sec:3.5}. This approximation can affect the accuracy of conserved quantities in \eqref{p4.eq:4.4}. Therefore, the accuracy of the DEIM approximation must be chosen higher than the one of POD.
