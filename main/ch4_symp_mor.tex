...
\item If $A$ is an ortho-symplectic of the form $A = [e_1,\dots,e_k,\mathbb J_{2n}^Te_1,\dots,J_{2n}^Te_k]$, then $(A^+)^T = A$.
\end{enumerate}
\end{proposition}
}
\begin{proof}
