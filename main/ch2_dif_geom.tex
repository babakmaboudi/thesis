...
In \cref{section:2.3} we saw two intrinsic feature of Hamiltonian systems: conservation of the Hamiltonian, expressed in \Cref{theorem:2.10}, and the symplecticity of the Hamiltonian flow, discussed in \Cref{theorem:2.9}.
