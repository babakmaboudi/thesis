...
\end{definition}
\begin{definition}
	The flow of a complete vector filed $X$ is the unique map $\varphi:\mathbb R \times \mathcal M \to \mathcal M$, such that $\varphi_t(p) = \varphi(t,p)$ is an integral curve through $p$.
\end{definition}
}
%\begin{definition}
