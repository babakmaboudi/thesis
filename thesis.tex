...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
% I commeneted the following lines, uncomment in the future
\frontmatter
...
\include{main/ch2_dif_geom}
\include{main/ch3_mor}
\include{main/ch4_symp_mor}
\include{main/ch5_symp_mor_norm}
\include{main/ch6_symp_mor_diss}
\include{main/ch7_beyond}
\include{main/ch8_conc}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
